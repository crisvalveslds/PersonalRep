...
print(f"The area of the square is: {area_square} cm squared or {area_square / 10000} m squared.")
...
print(f"The area of the rectangle is: {area_rectangle} cm squared or {area_rectangle / 10000} m squared.")

# Calculate for the circle
radius_circle = float(input("What is the radius of the circle? "))
length_circle = 2 * math.pi * radius_circle
print(f"The length of the circle is: {length_circle} cm.")
area_circle = math.pi * radius_circle ** 2
print(f"The area of the circle is: {area_circle} cm squared or {area_circle / 10000} m squared.") 